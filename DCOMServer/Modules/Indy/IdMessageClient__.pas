unit IdMessageClient__;

interface

uses
  Classes,
  IdMessage__, IdTCPClient__, IdHeaderList__,
  IdCoder__, IdCoderIMF__, IdCoder3To4__, IdCoderText__;
...
type
  ...
  protected
    ...
    procedure ReceiveBody(AMsg: TIdMessage); virtual;
    procedure ReceiveHeader(AMsg: TIdMessage; const ADelim: string); virtual;
    procedure ReceiveMsg(AMsg: TIdMessage; const ADelim: string); virtual;
    procedure SendBody(AMsg: TIdMEssage; const Attcount, Textcount, RelCount:
      integer); virtual;
    procedure SendMsg(AMsg: TIdMessage); virtual;
    procedure SendHeader(AMsg: TIdMessage; var AttCount, TextCount, RelCount:
      Integer); virtual;
    ...
    case StrToInt(Fetch(cRet, ';')) of
          ...
          begin
            ...
            begin
              if (
                ...
                IMFDecoder^.MP := TIdAttachment__.Create(AMsg.MessageParts);
              Created := True;
            end;
      ...
      CN_IMF_NEW_FILENAME:
        begin
          ...
          TIdAttachment__(IMFDecoder^.MP).FileName := DecodeHeader(cRet);
...
begin
  ...
  begin
    ...
    begin
      if AMsg.MessageParts.Items[i] is TIdAttachment__ then
      begin
...
procedure TIdMessageClient.SendBody(AMsg: TIdMEssage; const Attcount, Textcount,
  RelCount: integer);
...
var
  ...
  procedure EncodeAndWriteAttachment(AAttachment: TIdAttachment__);
  const
    DefaultLineSize = 57;
  var
    TFS: TFileStream;
  ...
  begin
    ...
    try
      ...
      TFS.Free;
      TFSTemp.Free;
      DeleteFile(AAttachment.StoredPathName);
      BodyCoder.Free;
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        EncodeAndWriteAttachment(AMsg.MessageParts.Items[i] as TIdAttachment__);
      end;
    end;
    WriteLn('--' + Boundary + '--');
  end
...
procedure TIdMessageClient.ReceiveHeader(AMsg: TIdMessage;
  const ADelim: string);
begin
