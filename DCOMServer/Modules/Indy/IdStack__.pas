...
type
  ...
  public
    ...
    function WSGetServByName(const AServiceName: string): Integer; virtual;
      abstract;
    function WSGetServByPort(const APortNumber: Integer): TStrings; virtual;
      abstract;
    ...
    property StackVersion: TIdStackVersion read FStackVersion;
  end;
...
begin
{$IFDEF LINUX}
  result := TIdStackLinux.Create;
{$ELSE}
  result := TIdStackWinsock.Create;
{$ENDIF}
end;
